...
DEFAULT_LOCATION = 'Taipei, 台北市, Taiwan'
SEARCH_LIMIT = 3
...
def get_reviews(api_key, business_id):
    ...
    Returns:
        list: The JSON response from the request.
    """
    reviews_path = BUSINESS_PATH + business_id + '/reviews'

    return request(API_HOST, reviews_path, api_key)['reviews']
...
def main():
    ...
    # ビジネスのレビューのハイライトを取得する
    print(get_reviews(API_KEY, 'yelp-taipei'))
